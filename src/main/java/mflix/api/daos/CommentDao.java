...
public class CommentDao extends AbstractMFlixDao {
    ...
    public boolean deleteComment(String commentId, String email) {
        ...
        if(commentId == null || email == null || commentId.isEmpty() || email.isEmpty()) {
            throw new IllegalArgumentException("A comment id and an email must be provided to remove the user comment.");
        }
    ...
    public List<Critic> mostActiveCommenters() {
        ...
        List<Bson> pipeline = Arrays.asList(
                Aggregates.group("$email", Accumulators.sum("count", 1L)),
